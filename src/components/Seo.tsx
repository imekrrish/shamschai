...
const pages:Record<string,[string,string]>={
  '/':['Sham’s Chai | Indian Masala Chai','Bold tea, warm spices and an everyday ritual. Explore Sham’s Masala Chai in 200 g, 500 g and 1000 g packs. Order directly on WhatsApp.'],
  '/products':['Shop Masala Chai | Sham’s Chai','Discover Sham’s signature Masala Chai. Choose your pack size and order directly with the team on WhatsApp.'],
  ...
  '/where-to-buy':['Where to Buy | Sham’s Chai','Order Sham’s Masala Chai directly on WhatsApp. Find updates about future shopping options.'],
  '/journal':['The Chai Journal | Sham’s Chai','Stories on chai, home, habit and the small moments that make a day feel familiar.'],
  '/contact':['Contact | Sham’s Chai','Questions, order support or gifting enquiries? Contact the Sham’s Chai team by email or WhatsApp.'],
  '/faq':['Frequently Asked Questions | Sham’s Chai','Answers about pack sizes, brewing, ingredients and ordering Sham’s Masala Chai.'],
  '/checkout':['Order on WhatsApp | Sham’s Chai','Choose your chai packs and share delivery details. Confirm availability, price and payment with Sham’s directly on WhatsApp.'],
  '/refund-policy':['Refund & Replacement Policy | Sham’s Chai','Read the existing Sham’s Chai refund and replacement policy, including order support and cancellations.'],
